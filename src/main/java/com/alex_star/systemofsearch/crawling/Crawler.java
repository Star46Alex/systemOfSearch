...
public class Crawler extends RecursiveTask<String> {

    private final String url;
    private final String startUrl;
    private boolean isInterrupted;
    public static final Set<String> allLinks = new HashSet<>();
    private final Set<Crawler> subTask = new HashSet<>();

    public Crawler(String url, String startUrl) {
        this.url = url.trim();
    ...
    private void findChildrenAndRunSubTasks(Document doc, Set<Crawler> subTask) {
        Elements elements;
        ...
        for (Element el : elements) {
            ...
            if (!allLinks.contains(attr) && attr.startsWith(startUrl)
                    ...
                    && !attr.contains(".xls")) {
                allLinks.add(attr);
                Crawler linkExecutor = new Crawler(attr, startUrl);
                linkExecutor.fork();
